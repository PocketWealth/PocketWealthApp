...
class ApiKeysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create api_key" do
    assert_difference("ApiKey.count") do
      post api_keys_url, params: { api_key: { access_token: @api_key.access_token, provider: @api_key.provider, refresh_token: @api_key.refresh_token, url: @api_key.url } }
    end
  ...
  test "should update api_key" do
    patch api_key_url(@api_key), params: { api_key: { access_token: @api_key.access_token, provider: @api_key.provider, refresh_token: @api_key.refresh_token, url: @api_key.url } }
